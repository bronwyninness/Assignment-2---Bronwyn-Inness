...
flexplot(neg_affect_total~mps.SPP.3y_total + sex|tipm_total, affect_data, method = "lm") ##CONFUSADO
...
full2 <- lm(neg_affect_total~mps.SPP.3y_total + sex + tipm_total, affect_data) ##how is this different than full1????
##compare models
